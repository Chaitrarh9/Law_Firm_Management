...
<form id="form1" name="form1" method="post" action="clientcasedetails_update.php">
  <p>&nbsp;</p>
  <table width="449" height="637" border="0" align="center">
    <tr>
      <td width="183" height="61">Client Id </td>
      <td width="256"><input name="client_id" type="text" id="client_id" value="<?php echo $row['client_id']?>" /></td>
    </tr>
    <tr>
      <td height="62">Advocate Id </td>
      <td><input name="advocate_id" type="text" id="advocate_id" value="<?php echo $row['advocate_id']?>" /></td>
    </tr>
    <tr>
      <td height="43">Case Name </td>
