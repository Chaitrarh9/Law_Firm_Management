...
<table width="382" border="0" align="center">
    <tr>
      <td width="157" height="71"><strong>Client Id </strong></td>
      <td width="209"><select name="client_id" id="client_id">
...
?>
    ...
    <tr>
      <td height="52"><strong>Amount Paid </strong></td>
    ...
    <tr>
      <td height="47"><strong>Cheque No </strong></td>
      <td><input name="cheque_no" type="text" id="cheque_no" value="<?php echo $row['cheque_no']?>" /></td>
    </tr>
    <tr>
      <td height="54"><strong>Payment Date </strong></td>
