...
<table width="343" height="272" border="0" align="center">
    <tr>
      <td width="144">Dictionary Word </td>
      <td width="183"><input name="dictionary_word" type="text" id="dictionary_word" value="<?php echo $row['dictionary_word']?>" /></td>
    </tr>
    <tr>
      <td height="79">Description</td>
