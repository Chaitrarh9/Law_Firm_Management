...
<form id="formID" name="form1" method="post" action="clientinsert.php">
  <p>&nbsp;</p>
  <table width="404" height="497" border="0" align="center">
    <tr>
      <td width="187"><strong>Client Name </strong></td>
      <td width="207"><input name="client_name" type="text" id="client_name" class="validate[required,custom[onlyLetter]]"/></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="44"><strong>Register Date </strong></td>
