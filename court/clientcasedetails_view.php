...
<?php include('header.php');?>
 ...
 $sn=1;
 $sql="select * from  client_case_details ccd, client_details cd, advocates_details ad, court_details cdd where ccd.client_id=cd.client_id and ccd.advocate_id=ad.advocate_id and ccd.court_id=cdd.court_id";
$res=mysql_query($sql); 
