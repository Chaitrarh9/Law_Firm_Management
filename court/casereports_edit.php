...
<table width="362" height="405" border="0" align="center">
    <tr>
      <td width="139" height="60">Report Name </td>
      <td width="207"><input name="report_name" type="text" id="report_name" value="<?php echo $row['report_name']?>" class="validate[required,custom[onlyLetter]]"/></td>
    </tr>
    <tr>
