...
<?php include('header.php');?>
 ...
 <?php include('sidebar.php');?>
  ...
  <thead>
  <tr>
    <td width="68"><strong>Sl No </strong></td>
    <td width="151"><strong>Article Name</strong></td>
    <td width="200"><strong>Short Description</strong></td>
    <td width="247"><strong>Complete Description</strong></td>
    <td width="42"><strong>Edit</strong></td>
    <td width="68"><strong>Delete</strong></td>
