...
<form id="formID" name="form1" method="post" action="articlesinsert.php">
  <p>&nbsp;</p>
  <table width="432" height="345" border="0" align="center">
    <tr>
      <td width="193" height="72"><strong>Article Name </strong></td>
      <td width="229"><input name="article_name" type="text" id="article_name" class="validate[required,custom[onlyLetter]]"/></td>
    </tr>
    <tr>
