...
$sql="select * from client_document cd,client_details c where cd.client_id=c.client_id and c.c_email_id='$uname'";
...
?>
  <tr>
    ...
    <td>&nbsp;<?php echo $row['doc_name']?></td>
	 <td><a href="upload/<?php echo $row['upload_doc'];?>">Document</a></td>
