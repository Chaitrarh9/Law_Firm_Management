                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span12 widget">
                                        <div class="widget-header">
                                            <span class="title">Case Schedules  View</span>
                                        </div>
...
$sql="select * from  case_schedules cs,client_case_details cd,advocates_details ad,client_details c where cs.`client _case_id`=cd.client_case_id and cd.advocate_id=ad.advocate_id and cd.client_id=c.client_id and c.c_email_id='$uname'";
