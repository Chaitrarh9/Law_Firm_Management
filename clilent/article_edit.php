...
<table width="371" height="429" border="0" align="center">
    <tr>
      <td width="148" height="63"><strong>Article Name </strong></td>
      <td width="213"><input name="article_name" type="text" id="article_name" value="<?php echo $row['article_name']?>"class="validate[required,custom[onlyLetter]]" /></td>
    </tr>
    <tr>
