...
<table width="366" height="326" border="0" align="center">
    <tr>
      <td width="135" height="52"><strong>Court Name</strong></td>
      <td width="215"><input name="court_name" type="text" id="court_name" value="<?php echo $row['court_name']?>" /></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="50"><strong>City</strong></td>
