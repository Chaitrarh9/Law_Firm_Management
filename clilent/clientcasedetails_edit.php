...
<form id="form1" name="form1" method="post" action="clientcasedetails_update.php">
  <p>&nbsp;</p>
  <table width="436" height="686" border="0" align="center">
    <tr>
      <td width="183" height="50"><strong>Client Id </strong></td>
      <td width="243"><input name="client_id" type="text" id="client_id" value="<?php echo $row['client_id']?>" /></td>
    </tr>
    <tr>
      <td height="48"><strong>Advocate Id </strong></td>
      <td><input name="advocate_id" type="text" id="advocate_id" value="<?php echo $row['advocate_id']?>" /></td>
    </tr>
    <tr>
      <td height="57"><strong>Case Name </strong></td>
      <td><input name="case_name" type="text" id="case_name" value="<?php echo $row['case_name']?>" /></td>
    </tr>
    <tr>
      <td height="102"><strong>Case Description </strong></td>
      <td><textarea name="case_description" id="case_description"><?php echo $row['case_description']?></textarea></td>
    </tr>
    <tr>
      <td height="59"><strong>Court Id </strong></td>
      <td><input name="court_id" type="text" id="court_id" value="<?php echo $row['court_id']?>" /></td>
    </tr>
    <tr>
      <td height="67"><strong>First Client Party </strong></td>
      <td><input name="first_client_party" type="text" id="first_client_party" value="<?php echo $row['first_client_party']?>" /></td>
    </tr>
    <tr>
      <td height="82"><strong>Second Client Party </strong></td>
    ...
    <tr>
      <td height="66"><strong>Status</strong></td>
    ...
    <tr>
      ...
      <td><div align="center">
        <input type="submit" name="Submit" class="btn btn-danger" value="clear" />
      </div></td>
    </tr>
  </table>
  <p>&nbsp;</p>
