...
<table width="396" height="356" border="0" align="center">
    <tr>
      <td width="137" height="60"><strong>Report Name </strong></td>
      <td width="243"><input name="report_name" type="text" id="report_name" value="<?php echo $row['report_name']?>" class="validate[required,custom[onlyLetter]]"/></td>
    </tr>
    <tr>
