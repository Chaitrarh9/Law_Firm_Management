...
<table width="397" border="0" align="center">
    <tr>
      <td width="180" height="53"><strong>Client Id </strong></td>
...
?>
    ...
    <tr>
      <td height="65"><strong>Amount Paid </strong></td>
    ...
    <tr>
      <td height="52"><strong>Paymode</strong></td>
    ...
    <tr>
      <td height="55"><strong>Bank Name</strong></td>
      <td><input name="bank_name" maxlength="20"type="text" id="bank_name" value="<?php echo $row['bank_name']?>" /></td>
    </tr>
    <tr>
      <td height="48"><strong>Cheque No </strong></td>
      <td><input name="cheque_no"maxlength="20" type="text" id="cheque_no" value="<?php echo $row['cheque_no']?>" /></td>
    </tr>
    <tr>
