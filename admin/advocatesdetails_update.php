...
$dictionary_id=$_POST["dictionary_id"]; include('../dbconnect.php');

$sql="update advocates_details set advocate_name='$advocate_name',date_of_birth='$date_of_birth',qualification='$qualification',address='$address',city='$city',
