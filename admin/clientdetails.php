...
<form id="formID" name="form1" method="post" action="clientinsert.php">
  <p>&nbsp;</p>
  <table width="448" height="468" border="0" align="center">
    <tr>
      <td width="196" height="66"><strong>Client Name </strong></td>
      <td width="242"><input name="client_name" maxlength="10" type="text" id="client_name" class="validate[required,custom[onlyLetter]]"/></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="49"><strong>Register Date </strong></td>
