...
?>
  <tr>
    ...
    <td>&nbsp;<a href="dictionaries_edit.php?dictionary_id=<?php echo $row['dictionary_id'] ?>" class="btn btn-primary">Edit</a></td>
	<td>&nbsp;<a href="dictionaries_delete.php?dictionary_id=<?php echo $row['dictionary_id']?>" class="btn btn-danger" onClick="return confirm('Are u sure want to delete')">Delete</a></td>
  </tr>
  <?php
}
?>
