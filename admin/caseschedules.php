...
<form id="formID" name="form1" method="post" action="caseschedulesinsert.php">
  ...
  <table width="392" height="337" border="0" align="center">
    <tr>
      ...
      <td width="170"><input name="case_schedule_id" maxlength="10" type="text" id="case_schedule_id" class="validate[required,custom[onlyNumber]]" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input name="c_status" maxlength="15" type="text" id="c_status" class="validate[required,custom[onlyLetter]]" /></td>
    </tr>
    <tr>
      <td><div align="center">
