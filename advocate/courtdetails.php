...
<form id="form1" name="form1" method="post" action="courtdetailsinsert.php">
  ...
  <table width="397" height="400" border="0" align="center">
    <tr>
      ...
      <td width="103"><input name="court_id"maxlength="10" type="text" id="court_id" /></td>
    </tr>
    <tr>
      <td>Court Name</td>
      <td><input name="court_name" maxlength="50"type="text" id="court_name" /></td>
    </tr>
    <tr>
      <td>Address</td>
      <td><textarea name="address"maxlength="100" id="address"></textarea></td>
    </tr>
    <tr>
      <td>City</td>
