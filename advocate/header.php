...
?>
                        ...
                        <div id="header-functions" class="pull-right">
                        	<div id="user-info" class="clearfix">
                                <span class="info">
                                	Welcome
                                    <span class="name"><?php echo $adv_nm;?></span>
                                </span>&nbsp;&nbsp;
								<a href="change pwd.php"><font color="#FFFF00">Change Pin </font></a>
                            </div>
                             <div id="logout-ribbon">
                            	<a href="../logout.php" onClick="return confirm('Are u sure want to Logout...')"><i class="icon-off"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
