...
<table width="387" border="0" align="center">
    <tr>
      <td width="170" height="52"><strong>Client Id </strong></td>
...
?>
    ...
    <tr>
      <td height="73"><strong>Amount Paid </strong></td>
      <td><input name="amount_paid" maxlength="100"type="text" id="amount_paid" value="<?php echo $row['amount_paid']?>" /></td>
    </tr>
    <tr>
      <td><strong>Description</strong></td>
      <td><textarea name="description"maxlength="100" id="description"><?php echo $row['description']?></textarea></td>
    </tr>
    <tr>
      <td height="56"><strong>Paymode</strong></td>
    ...
    <tr>
      <td height="75"><strong>Bank Name</strong></td>
      <td><input name="bank_name" maxlength="30"type="text" id="bank_name" value="<?php echo $row['bank_name']?>" /></td>
    </tr>
    <tr>
      <td height="55"><strong>Cheque No </strong></td>
      <td><input name="cheque_no"maxlength="30" type="text" id="cheque_no" value="<?php echo $row['cheque_no']?>" /></td>
    </tr>
    <tr>
      <td height="39"><strong>Payment Date </strong></td>
