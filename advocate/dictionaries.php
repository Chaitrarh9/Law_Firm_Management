...
<form id="formID" name="form1" method="post" action="dictionariesinsert.php">
  ...
  <table width="415" height="181" border="0" align="center">
    <tr>
      <td width="110" height="93"><strong>Dictionary Word </strong></td>
      <td width="217"><input name="dictionary_word"maxlength="30" type="text"  class="validate[required,custom[onlyLetter]]" id="dictionary_word" value="<?php echo $row['dictionary_word']?>"/></td>
    </tr>
    <tr>
      <td height="40"><strong>Description</strong></td>
      <td><textarea name="description"maxlength="200" id="description"><?php echo $row['description']?></textarea></td>
    </tr>
    <tr>
