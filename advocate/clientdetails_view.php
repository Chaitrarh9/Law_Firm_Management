...
?>
  <tr>
    ...
    <td>&nbsp;<a href="clientdetails_edit.php?client_id=<?php echo $row['client_id']; ?>" class="btn btn-primary">Edit</a></td>
    <td>&nbsp;<a href="clientdetails_delete.php?client_id=<?php echo $row['client_id']; ?>" class="btn btn-danger" onClick="return confirm('Are u sure want to delete')">Delete</a></td>
  </tr>
  <?php
}
?>
