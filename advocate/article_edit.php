...
<table width="331" height="301" border="0" align="center">
  <tr>
    <td width="133"><strong>Article Name </strong></td>
    <td width="182"><input name="article_name" maxlength="50"type="text" id="article_name" value="<?php echo $row['article_name']?>"class="validate[required,custom[onlyLetter]]" /></td>
  </tr>
  <tr>
    <td><strong>Short Description </strong></td>
    <td><textarea name="short_description"maxlength="100" id="short_description"><?php echo $row['short_description']?></textarea></td>
  </tr>
  <tr>
    <td><strong>Complete Description </strong></td>
    <td><textarea name="complete_description"maxlength="100" id="complete_description"><?php echo $row['complete_description']?></textarea></td>
  </tr>
  <tr>
