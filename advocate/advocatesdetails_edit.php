...
<table width="446" border="0" align="center">
    <tr>
      ...
      <td width="104"><input name="advocate_name"maxlength="20" type="text" id="advocate_name" value="<?php echo $row['advocate_name']?>" class="validate[required,custom[onlyLetter]]"/></td>
    </tr>
    <tr>
      <td>Dob</td>
    ...
    <tr>
      <td height="52">Bar Council Name </td>
    ...
    <tr>
      <td height="54">Advocate Type </td>
      <td><input name="advocate_type"maxlength="20" type="text" id="advocate_type" value="<?php echo $row['advocate_type']?>" cla"validate[required,custom[onlyLetter]]"/></td>
    </tr>
    <tr>
      <td height="90"><label>
          <div align="center">
