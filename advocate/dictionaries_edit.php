...
<table width="343" height="195" border="0" align="center">
    <tr>
      <td width="110"><strong>Dictionary Word </strong></td>
      <td width="217"><input name="dictionary_word"maxlength="30" type="text" id="dictionary_word" value="<?php echo $row['dictionary_word']?>" /></td>
    </tr>
    <tr>
      <td height="40"><div align="left"><strong>Description</strong></div></td>
      <td><input name="description" maxlength="100"type="text" id="description" value="<?php echo $row['description']?>" /></td>
    </tr>
    <tr>
      <td height="40">
        <div align="center">
