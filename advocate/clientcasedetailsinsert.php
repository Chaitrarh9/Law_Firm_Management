...
$sql="insert into client_case_details values(null,'$client_id','$advocate_id','$case_name','$case_description',
'$court_id','$first_client_party','$second_client_party','$date','Active')";
